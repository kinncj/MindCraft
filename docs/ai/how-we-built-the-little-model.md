...
```
8192 hashed feature buckets × 82 labels
one byte per weight, 90% of them pruned to zero
145,713 generated training sentences
held-out accuracy 98.0%
132 KB gzipped — 875 KB of base64 in the source
```
...
```
145713 sentences, 82 labels, 8192 buckets
epoch 5:  loss 0.1051
...
| **8192** | **90%** | **98.0%** | **132.4 KB** | **what ships** |
