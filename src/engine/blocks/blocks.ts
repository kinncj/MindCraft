...
const DEFINITIONS: BlockDefinitionInput[] = [
  ...
  { id: 'wood', smooth: 'wood', numericId: 22, label: 'Wood', category: 'building', emoji: '🪵', color: '#c98d4b', accentColor: '#dba362', textures: { top: 'wood_top', side: 'wood_side', bottom: 'wood_top' } },
  { id: 'birch_wood', smooth: 'wood', numericId: 23, label: 'Pale Wood', category: 'building', emoji: '🪵', color: '#ecebe4', textures: { top: 'birch_top', side: 'birch_side', bottom: 'birch_top' } },
  ...
  { id: 'flower_pink', replaceable: true, numericId: 63, label: 'Pink Flower', category: 'nature', emoji: '🌸', color: '#f291bb', shape: 'cross', collision: 'none', bucket: 'plants' },
  { id: 'flower_yellow', replaceable: true, numericId: 64, label: 'Yellow Flower', category: 'nature', emoji: '🌼', color: '#ffd94a', shape: 'cross', collision: 'none', bucket: 'plants' },
  { id: 'flower_blue', replaceable: true, numericId: 65, label: 'Blue Flower', category: 'nature', emoji: '💠', color: '#6aa8f0', shape: 'cross', collision: 'none', bucket: 'plants' },
  { id: 'flower_red', replaceable: true, numericId: 66, label: 'Red Flower', category: 'nature', emoji: '🌹', color: '#e8574f', shape: 'cross', collision: 'none', bucket: 'plants' },
  { id: 'tall_grass', replaceable: true, numericId: 67, label: 'Tall Grass', category: 'nature', emoji: '🌾', color: '#67c23a', shape: 'cross', collision: 'none', bucket: 'plants' },
  { id: 'mushroom', replaceable: true, numericId: 68, label: 'Mushroom', category: 'nature', emoji: '🍄', color: '#e8574f', shape: 'cross', collision: 'none', bucket: 'plants' },
  ...
  { id: 'water', replaceable: true, smooth: 'water', shape: 'fluid', numericId: 71, label: 'Water', category: 'nature', emoji: '💧', color: '#4fa8e8', accentColor: '#7cc2f2', transparent: true, opacity: 0.75, bucket: 'water', collision: 'fluid' },
  ...
  { id: 'repeater', numericId: 131, label: 'Repeater', category: 'special', emoji: '🔁', color: '#b9c0c8', shape: 'carpet', collision: 'none', facesPlayer: true, textures: { top: 'repeater', side: 'repeater', bottom: 'repeater' }, variants: { 1: { top: 'repeater_on', side: 'repeater_on', bottom: 'repeater_on' } }, logic: { role: 'repeater', kind: 'repeater' }, immovable: true },
  { id: 'flip_block', numericId: 132, label: 'Flip Block', category: 'special', emoji: '🔀', color: '#6f665a', textures: { top: 'flip_block', side: 'flip_block', bottom: 'flip_block' }, variants: { 1: { top: 'flip_block_on', side: 'flip_block_on', bottom: 'flip_block_on' } }, logic: { role: 'inverter', kind: 'flip' }, immovable: true },
  ...
  { id: 'flower_pot', numericId: 97, label: 'Flower Pot', category: 'furniture', emoji: '🪴', color: '#c96f25', shape: 'cross', collision: 'none', bucket: 'plants', textures: { top: 'flower_pot', side: 'flower_pot', bottom: 'flower_pot' } },
