...
const DEFINITIONS: BlockDefinitionInput[] = [
  ...
  { id: 'flower_pink', numericId: 63, label: 'Pink Flower', category: 'nature', emoji: '🌸', color: '#f291bb', shape: 'cross', collision: 'none', bucket: 'alpha' },
  { id: 'flower_yellow', numericId: 64, label: 'Yellow Flower', category: 'nature', emoji: '🌼', color: '#ffd94a', shape: 'cross', collision: 'none', bucket: 'alpha' },
  { id: 'flower_blue', numericId: 65, label: 'Blue Flower', category: 'nature', emoji: '💠', color: '#6aa8f0', shape: 'cross', collision: 'none', bucket: 'alpha' },
  { id: 'flower_red', numericId: 66, label: 'Red Flower', category: 'nature', emoji: '🌹', color: '#e8574f', shape: 'cross', collision: 'none', bucket: 'alpha' },
  { id: 'tall_grass', numericId: 67, label: 'Tall Grass', category: 'nature', emoji: '🌾', color: '#67c23a', shape: 'cross', collision: 'none', bucket: 'alpha' },
  { id: 'mushroom', numericId: 68, label: 'Mushroom', category: 'nature', emoji: '🍄', color: '#e8574f', shape: 'cross', collision: 'none', bucket: 'alpha' },
