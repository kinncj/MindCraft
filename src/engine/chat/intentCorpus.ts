...
export const LABEL_WORDS: Record<IntentLabel, string[]> = {
  ...
  m_tokyo_tower: ['tokyo tower', 'the orange and white tower in tokyo', 'the red tower in japan', 'tokyo eiffel tower'],
  m_skytree: ['skytree', 'tokyo skytree', 'the tallest tower in japan', 'the tall tower in tokyo', 'sky tree'],
  m_sensoji: ['sensoji', 'senso ji', 'asakusa temple', 'the temple with the big red lantern', 'kaminarimon', 'the japanese temple with the pagoda', 'pagoda'],
  m_canada_place: ['canada place', 'the building with the white sails', 'the sails in vancouver', 'the cruise ship building'],
  m_science_world: ['science world', 'the big silver ball in vancouver', 'the geodesic dome', 'the science ball'],
  ...
  city_tokyo: ['tokyo', 'tokyo japan', 'the city of tokyo'],
  city_vancouver: ['vancouver', 'vancouver canada', 'the city of vancouver', 'vancouver bc'],
  city_rio: ['rio', 'rio de janeiro', 'the city of rio', 'rio brazil'],
